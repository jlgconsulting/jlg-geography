...
public class CartesianPolygonTest {
    ...
    public void the_get_bounding_box_should_return_correct_bounding_box() {
        ...
        assertEquals(1, boundingBox.getMinCoordinate().getLongitude());
        assertEquals(1, boundingBox.getMinCoordinate().getLatitude());
        assertEquals(2, boundingBox.getMaxCoordinate().getLongitude());
        assertEquals(2, boundingBox.getMaxCoordinate().getLatitude());
    }
